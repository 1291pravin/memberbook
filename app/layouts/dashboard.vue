...
const allNavItems = computed(() => [
  ...
  { to: "/dashboard/plans", label: "Plans", icon: icon("M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15a2.25 2.25 0 012.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z"), primary: true },
  ...
  { to: "/dashboard/check-ins", label: "Check-Ins", icon: icon("M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"), primary: false },
  { to: "/dashboard/seats", label: "Seats", icon: icon("M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z"), primary: false },
...
// Items in the "More" menu - filter based on progressive disclosure
const moreNavItems = computed(() => {
  const all = allNavItems.value;
  const showAll = memberCount.value >= 5 || showAllNav.value;
  if (showAll) {
    return [all[2]!, all[4]!, all[5]!, all[6]!, all[7]!, all[8]!, all[9]!];
  }
  return [all[2]!, all[9]!]; // Plans + Settings only
});
