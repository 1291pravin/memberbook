<template>
  <div class="min-h-[80vh] flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      <h1 class="text-2xl font-bold text-gray-900 text-center mb-2">Set up your workspace</h1>
      <p class="text-center text-sm text-gray-500 mb-8">Tell us about your business</p>
